...
@section('content')
    ...
    <style>
        ...
        .type-like { background: #ff6b6b; }
        .type-comment { background: #4ecdc4; }
        .type-follow { background: #45b7d1; }
        .type-share { background: #feca57; }
        .type-mention { background: #5f27cd; }
            ...
            <div class="notifications-header">
                <div class="header-content">
                    <h1 class="page-title">
                        ...
                        Notifikasi
                        <div class="notification-badge" id="notificationCount">12</div>
                    </h1>
    ...
    <script>
        ...
        const sampleNotifications = [
            {
                id: 1,
                type: 'like',
                user: { name: 'Alice Johnson', username: 'alice_photo', initial: 'A' },
                action: 'menyukai',
                target: 'foto Anda',
                postPreview: 'Pemandangan sunset di Pantai Kuta yang memukau...',
            ...
            },
            {
                id: 2,
                type: 'comment',
                user: { name: 'Bob Wilson', username: 'bob_travel', initial: 'B' },
                action: 'mengomentari',
                target: 'postingan Anda',
                postPreview: 'Tips traveling murah ke Yogyakarta untuk backpacker...',
                comment: 'Sangat bermanfaat! Terima kasih sudah berbagi tips ini.',
            ...
            },
            {
                id: 3,
                type: 'follow',
                user: { name: 'Charlie Brown', username: 'charlie_art', initial: 'C' },
                action: 'mulai mengikuti',
                target: 'Anda',
            ...
            },
            {
                id: 4,
                type: 'mention',
                user: { name: 'Diana Chen', username: 'diana_food', initial: 'D' },
                action: 'menyebut Anda dalam',
                target: 'sebuah postingan',
                postPreview: 'Resep rendang enak ala @username yang harus dicoba...',
            ...
            },
            {
                id: 5,
                type: 'share',
                user: { name: 'Evan Rodriguez', username: 'evan_tech', initial: 'E' },
                action: 'membagikan',
                target: 'postingan Anda',
                postPreview: 'Tutorial belajar programming untuk pemula...',
            ...
            },
            {
                id: 6,
                type: 'like',
                user: { name: 'Fiona Lee', username: 'fiona_music', initial: 'F' },
                action: 'menyukai',
                target: 'komentar Anda',
                postPreview: 'Diskusi tentang musik indie Indonesia...',
            ...
            },
            {
                id: 7,
                type: 'comment',
                user: { name: 'George Martin', username: 'george_sport', initial: 'G' },
                action: 'mengomentari',
                target: 'foto Anda',
                postPreview: 'Olahraga pagi di taman kota...',
                comment: 'Semangat pagi! Jadi ikut termotivasi nih.',
            ...
            },
            {
                id: 8,
                type: 'follow',
                user: { name: 'Hannah Davis', username: 'hannah_books', initial: 'H' },
                action: 'mulai mengikuti',
                target: 'Anda',
        ...
        function createNotificationHTML(notification) {
            ...
            const actionButtons = notification.type === 'follow' ? `
                <div class="notification-actions">
                    <button class="notification-btn primary" onclick="followBack(${notification.user.id})">
                ...
                <div class="notification-item ${!notification.read ? 'unread' : ''}" data-id="${notification.id}">
                    ...
                    <div class="notification-content">
                        <div class="notification-text">
                            <span class="username">@${notification.user.username}</span>
        ...
        function followBack(userId) {
            ...
            // Here you would make an API call to follow the user
        }

        function viewProfile(username) {
            showNotification(`Membuka profil @${username}`);
            // Here you would redirect to the user's profile
        ...
        function addNewNotification() {
            ...
            if (currentFilter === 'all' || 
                (currentFilter === 'likes' && newNotification.type === 'like') ||
                (currentFilter === 'comments' && newNotification.type === 'comment') ||
                (currentFilter === 'follows' && newNotification.type === 'follow')) {
                loadNotifications();
            } else {
                updateNotificationCount();
            }
